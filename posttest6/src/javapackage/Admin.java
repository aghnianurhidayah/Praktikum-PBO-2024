...
public final class Admin implements Features {

    private final String un_admin = "admin";
    private final String pw_admin = "admin123";

    public final void addAdminAcc() {
        Account admin = new Account(un_admin, pw_admin, true);
        accList.add(admin);
    }
    ...
    public void add() {
        try {
            ...
            String inputage = App.in.nextLine();
            int emp_age = Integer.parseInt(inputage);
            System.out.print("Salary    : Rp.");
            String inputsalary = App.in.nextLine();
            float emp_salary = Float.parseFloat(inputsalary);
    ...
    public void update() {
        try {
            ...
            System.out
                    .println("=======================================================================================");
            System.out.println("Employee changed failed!");
            System.out.println("Error: Input must be number.");
        }
