...
public class Admin{
    ...
    public void read_emp() {
        ...
        if (employeeList.isEmpty()){
            ...
            System.out.println("=======================================================================================");
            System.out.println("|   ID   |         Name          |  Age  |   Salary   |    Username    |   Password   |");
            System.out.println("=======================================================================================");
            for (Employee getEmp : employeeList){
                System.out.printf("|%-8s", getEmp.getIdEmp());
                System.out.printf("|%-23s", getEmp.getNameEmp());
                System.out.printf("|%-7s", getEmp.getAgeEmp());
                System.out.printf("|%-12s", getEmp.getSalaryEmp());
